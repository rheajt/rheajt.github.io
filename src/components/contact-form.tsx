...
export const ContactForm = (props: ContactFormProps) => {
    ...
    createEffect(() => {
        ...
        const pct = Math.min(
            100,
            Math.max(0, ((charCount / 100) * 100 + (wordCount / 50) * 100) / 2),
        );
        setPercentage(pct);
        if (
            pct === 100 &&
            v.your_name.length !== 0 &&
            v.your_email.length !== 0
        ) {
            setIsDisabled(false);
        } else {
            setIsDisabled(true);
                ...
                <StyledForm onSubmit={handleSubmit}>
                    <StyledFormInput>
                        ...
                        <input
                            ...
                            onInput={e =>
                                handleChange("your_name", e.currentTarget.value)
                            }
                        />
                    </StyledFormInput>
                    <StyledFormInput>
                    ...
                    <StyledFormInput class="full-width">
                        <label for="message">
                            Send me a message! I love meeting new people and
