...
const Share = (props: { url: string }) => {
    return (
        <StyledShareIcons>
            <li>
                ...
                >
                    <svg viewBox="0 0 64 64" width="30" height="30">
                        ...
                        ></rect>
                        <path
                            d="M17,22v20h30V22H17z M35.4,32L47,22.1V41.9L35.4,32z M25.6,32L17,38.1V22.1L25.6,32z M32,33.6L18.9,43h26.2L32,33.6z M32,30.4L45.1,21H18.9L32,30.4z"
                            fill="white"
                        ></path>
                    </svg>
                </a>
            ...
            <li>
                <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(props.url)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Twitter"
                >
            ...
            <li>
                <a
                    href={`https://www.reddit.com/submit?url=${encodeURIComponent(props.url)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    title="Reddit"
                >
