              ...
              <div className="col-2">
                <div className="col-12 quick-links2 gen-text-center">
                  ...
                  <div
                    ...
                    style={{ fontSize: 12, position: 'relative', left: 20 }}
                  >
                    Fair information
                    <br />
                    {' '}
...
To personalize your experience and to allow us
              to deliver the type of content and product offerings in which you
              are most interested.
            </div>
            <div className="innerText">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
correspondence.
          ...
          <div className="innerText">
            <a href="https://jordanrhea.com">jordanrhea.com</a>
          </div>
          <div className="innerText">
            <a href="mailto:jordan@jordanrhea.com">jordan@jordanrhea.com</a>
          </div>
        </div>
      </div>
    </div>
