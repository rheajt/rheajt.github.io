...
const TermsOfService = props => (
  <Layout title="Terms of Service">
    <div>
      ...
      <p>Last updated: April 25, 2019</p>

      <p>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions")
        carefully before using the https://jordanrhea.com website (the
        "Service") operated by jordanrhea.com ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        Service. The Terms and Conditions agreement for jordanrhea.com has been
      ...
      <p>
        ...
        are not owned or controlled by jordanrhea.com.
      </p>

      <p>
        jordanrhea.com has no control over, and assumes no responsibility for,
        the content, privacy policies, or practices of any third party web sites
        or services. You further acknowledge and agree that jordanrhea.com shall
      ...
      <p>
        ...
        of Virginia, United States, without regard to its conflict of law
        provisions.
      </p>
