...
`;v(["click"]);var j=c("<h1>Poker Tracker");const f={name:"",hero:!1,in:0};function G(){const[r,t]=y([{...f}]);function o(e,i){t(d=>{const n=[...d];return n[e]={...n[e],...i},n})}function s(){t(e=>[...e,{...f}])}return l(A,{get children(){return[l(R,{title:"Poker"}),l(T,{get children(){return[u(j),l(B,{get seats(){return r()},handleUpdateSeat:o,handleAddSeat:s}),l(O,{get seats(){return r()}})]}})]}})}export{G as default};
